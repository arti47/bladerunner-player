...
tracker** (die-rated leads, upgrade/downgrade); NPC Skill Level table, NPC Tactics, NPC Chase
Maneuvers; Case File Tables (Cipher, victims/motives, etc.); Location table; Downtime Event
table; Countdown Event table. Enumerate all tables in Phase 0/6.
