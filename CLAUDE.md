...
- [x] **Hardening (always):** committed regression-test harness (`tests/` + `package.json`,
  dev-only `playwright-core`, `npm test` = **66 checks: 40 Node unit + 26 headless smoke**) ✅;
